...
using SharpSerializerLibrary.Core.Xml;

namespace SharpSerializerLibrary.Advanced
{
    /// <summary>
    ...
    public sealed class XmlPropertyDeserializer : IPropertyDeserializer
    {
        ...
        {
            // ElementType
            property.ElementType = property.Type != null ? SharpSerializerLibrary.Serializing.TypeInfo.GetTypeInfo(property.Type).ElementType : null;
        ...
        private void parseDictionaryProperty(DictionaryProperty property)
        {
            ...
            {
                var typeInfo = SharpSerializerLibrary.Serializing.TypeInfo.GetTypeInfo(property.Type);
